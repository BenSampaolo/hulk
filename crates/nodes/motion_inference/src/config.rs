...
impl Parameters {
    pub fn validate(&self) -> Result<()> {
        ...
        let t = &self.timing;
            ...
            t.policy_period <= t.maximum_input_age,
            "policy_period must not exceed maximum_input_age"
        );
        ensure!(
            t.sensor_period <= t.maximum_input_age,
            "sensor_period must not exceed maximum_input_age"
        );
