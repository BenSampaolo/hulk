...
pub struct Observation {
    ...
    pub strong: bool,
    pub quick: bool,
    pub ball_velocity: linear_algebra::Vector2<Walk>,
    pub target_speed: f32,
    pub previous_ball_position: Point2<Walk>,
...
impl Observation {
    pub fn new(
        ...
        request: KickRequest,
        soft: bool,
        (ball_position, previous_ball_position): (Point2<Walk>, Point2<Walk>),
    ) -> Self {
